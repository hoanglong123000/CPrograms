...
void Menu()
{
    ...
    do {
		...
		printf("\n");
		printf(" 1: RANDOMLY INITIALIZING \n");
		
		printf("\n");
		printf(" 2: OUTPUT THE MATRIX \n");
		
		printf("\n");
	    printf(" 3: OUTPUT THE ODD EVEN MATRIX \n");
	    ...
	    printf("\n");
	    printf("\n 6: FIND X ON THE MATRIX \n");
	    
	    printf("\n");
	    printf("\n 7: AVERAGE OF THE MATRIX \n");
	    
	    printf("\n");
	    printf("\n 8: TOTAL OF MAIN DIAGONAL \n");
	    
	    printf("\n");
	    printf("\n 9: TOTAL OF SECONDARY DIAGONAL \n");
	    
	    printf("\n");
	    printf("\n 10: ELEMENTS UNDER THE MAIN DIAGONAL \n");
	    
	    printf("\n");
	    printf("\n 11: ELEMENTS ON THE SECONDARY DIAGONAL \n");
		...
		if (choice == 12)
		{
			printf("\n---THANKS FOR USING MY C PROGRAM---\n");
			printf("\n----DEVELOPED BY RUAN HUANG LONG-------\n");
		}
